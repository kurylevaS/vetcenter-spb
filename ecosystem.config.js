  ...
  apps: [
    {
      ...
      args: 'start',
      cwd: '/var/www/vetcenter-spb/current',
      instances: 2, // Количество инстансов (можно использовать 'max' для использования всех CPU)
      ...
      // Логирование
      error_file: '/var/www/vetcenter-spb/shared/logs/error.log',
      out_file: '/var/www/vetcenter-spb/shared/logs/out.log',
      log_file: '/var/www/vetcenter-spb/shared/logs/combined.log',
      time: true,
      // Формат логов
      ...
      env_file: '/var/www/vetcenter-spb/shared/.env.production',
    },
  ],
};
